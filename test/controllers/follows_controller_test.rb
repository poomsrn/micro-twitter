...
class FollowsControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post follows_url, params: { follow: { followee_id: @follow.followee_id, follower_id: @follow.follower_id } }
  #   end
  ...
  #   patch follow_url(@follow), params: { follow: { followee_id: @follow.followee_id, follower_id: @follow.follower_id } }
